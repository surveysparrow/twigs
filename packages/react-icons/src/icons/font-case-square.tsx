...
export const FontCaseSquareIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({
    ...
    return (
      <svg
        ...
        ref={ref}
      >
        <g clipPath="url(#clip0_22_218)">
          <path
            d="M8.68 18.4267H14.9333"
            stroke={color}
          ...
          />
          <path
            d="M8 20.0133L11.8133 11.1733L15.6133 20.0133"
            stroke={color}
            strokeWidth={strokeWidth}
            strokeLinecap="round"
            strokeLinejoin="round"
