...
export { DashboardGaugeColorIcon } from './dashboard-gauge-color';
...
export { EmailLetterIcon } from './email-letter';
...
export { SpaceRocketIcon } from './space-rocket';
...
export { ThankyouColorIcon } from './thankyou-color';
