---
title: Cascader
description: A hierarchical dropdown component that enables users to navigate through nested option structures and select values from multi-level menus. Perfect for complex data selection scenarios.
---
...
We have stored the `test-data` seperately for the easy accessibility, all the example using the same data.
</Callout>
...
<Playground snippetName="cascader-features" defaultPlayground />
