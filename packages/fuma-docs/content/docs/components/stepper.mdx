---
title: Stepper
description: A multi-step navigation component that guides users through a sequence of related actions. Perfect for forms, wizards, and complex workflows with customizable styling, step states, and interactive navigation.
---
...
<Playground snippetName="stepper-customizations" /> 