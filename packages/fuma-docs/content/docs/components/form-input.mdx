---
title: FormInput
description: A comprehensive form input that combines Input, FormLabel, and FormHelperText components. Provides built-in support for labels, error messages, helper text, character counting, and various styling options.
---
...
<Playground snippetName="form-input-advanced" defaultPlayground /> 