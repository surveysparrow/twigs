...
import { Editor, EditorToolbar, RichEditor, EditorLookupDropdownBase } from "@sparrowengg/twigs-editor-react";
...
function checkForSlashes(text: string, minMatchLength: number) {
...
export default function EditorTutorialSlashCommands() {
  return (
    <Editor>
      <EditorToolbar />
      <RichEditor />
