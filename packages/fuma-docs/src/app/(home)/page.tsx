  ...
  return (
    <main className="main px-5 lg:px-6">
      <div className="w-full max-w-fd-container mx-auto my-24">
        ...
        Twigs is a flexible, customizable and accessible React component library for building UIs. 
        Comes with 30+ components and room for you to bring your own components, styles and themes.
        </p>
        <Link
