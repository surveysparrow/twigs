  ...
  return (
    <Flex gap="$4" flexDirection="row">
      ...
      >
        ...
        <Text size="sm" weight="bold" css={{ color: "$neutral900", fontSize: "$3xl" }}>$ 8740</Text>
        <Flex
          alignItems="center"
          gap="$4"
        >
      ...
      >
        ...
        >
          <Image src={moviebg.src} alt="movie bg" css={{ borderTopLeftRadius: "$2xl", borderTopRightRadius: "$2xl", "@media (max-width: 1074px)": { width: "100%" } }} />
          <Box css={{ padding: "$2 0", borderRadius: "$md", position: "absolute", bottom: -15, left: "calc(50% - 25px)", backgroundColor: "white",boxShadow: "0px 4px 6px 0px rgba(0, 0, 0, 0.1)" }}>
        ...
        <Text size="xs" css={{ 
          color: "$neutral700", textAlign: "center", paddingLeft: "$5", paddingRight: "$5", paddingBottom: "$4",
          "@media (max-width: 768px)": {
            paddingLeft: "$4",
            paddingRight: "$4",
            paddingBottom: "$4",
