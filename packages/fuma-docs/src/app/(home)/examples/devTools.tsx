  ...
  return (
    <>
      <div className="flex flex-col gap-4 lg:w-1/2 md:w-2/4 mx-6">
        <div>
          <h2 className="text-center text-3xl md:text-4xl font-medium mb-2 break-words leading-tight text-neutral-900">
          ...
          <TabsContent value="tab1" className="rounded-lg !p-0 relative w-fit">
            <div className="relative p-0.5 rounded-lg bg-black/90 min-w-[342px]">
              ...
              <div className="relative w-full lg:w-[620px] h-auto overflow-hidden rounded-lg min-h-[161px]">
                <div key={currentImageIndex} className="image-slide-container">
                  <Image
