...
| label                | Label for the date picker                                               | string                                       |          |
| size                 | Size of the calendar                                                    | `'lg' \| 'md' \| 'sm'`                      | "lg"     |
| enablePortal         | Calendar popover will render in body                                    | boolean                                      | false    |
| portalTarget         | Render Calendar Popover in specific element                             | Element                                      |          |
| showTimePicker       | Show the time picker                                                    | boolean                                      | false    |
| showTimezonePicker   | Show the timezone picker                                                | boolean                                      | false    |
| hourCycle            | Hour cycle - 12 for 12-hour format with AM/PM, 24 for 24-hour format   | `12 \| 24`                                   | 12       |
