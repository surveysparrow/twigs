...
describe('Pagination', () => {
  it('renders without crashing', () => {
    render(<Pagination activePage={4} itemsPerPage={10} total={100} />);
  });
  ...
  it('previous button is disabled', async () => {
    render(<Pagination activePage={1} itemsPerPage={10} total={100} />);
  ...
  it('next button should be disabled', async () => {
    render(<Pagination activePage={10} itemsPerPage={10} total={100} />);
  ...
  it('has correct number of page links', async () => {
    ...
    render(<Pagination activePage={1} itemsPerPage={2} total={10} />);
